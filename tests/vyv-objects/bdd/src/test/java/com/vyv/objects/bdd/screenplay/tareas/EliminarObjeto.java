...
/** Tarea Screenplay: eliminar un objeto de la pagina via DELETE. */
public final class EliminarObjeto
{
    private EliminarObjeto()
    {
    }

    public static Tarea numerado(String clase, int numero)
    {
        return actor -> actor.usando(UsarLaApiDeObjetos.class).eliminarObjeto(clase, numero);
    }
}
