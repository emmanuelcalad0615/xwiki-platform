...
## Resumen de evidencia local (sin Docker ni keys)

```text
Unitarias objects : Tests run: 14, Failures: 0, Errors: 0  (BUILD SUCCESS)
Suite del equipo  : Tests run: 45, Failures: 0, Errors: 0, Skipped: 1 (plantilla attachments)
BDD objects       : Tests run: 9,  Failures: 0, Errors: 0  (BUILD SUCCESS)
```
